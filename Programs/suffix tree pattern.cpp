...
public: 
	...
	The returned indexes are indexes of last characters of matched text. */
...
{ 
    /* Let us call recursive search function for root of Trie. 
       We get a list of all indexes (where pat is present in text) in  variable 'result'*/ 
